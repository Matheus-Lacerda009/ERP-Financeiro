...
public class ReplicationConnectionUrl extends ConnectionUrl {
     ...
     * instead of net.financeiro.connection string parsing.
     * {@link ConnectionUrl} instances created by this process are not cached.
     *
     * @param sources
     *            the source hosts list to use in this net.financeiro.connection string
     * @param replicas
     *            the replica hosts list to use in this net.financeiro.connection string
     * @param properties
    ...
    /**
     * Returns an existing source host info with the same host:port part or spawns a new isolated host info based on this net.financeiro.connection URL if none was found.
     *
     * @param hostPortPair
    ...
    /**
     * Returns a list of this net.financeiro.connection URL source hosts in the form of host:port pairs.
     *
     * @return a list of this net.financeiro.connection URL source hosts in the form of host:port pairs
     */
    ...
    /**
     * Returns an existing replica host info with the same host:port part or spawns a new isolated host info based on this net.financeiro.connection URL if none was found.
     *
     * @param hostPortPair
     *            the host:port part to search for
     * @return the existing host info or a new independent one
    ...
    /**
     * Returns a list of this net.financeiro.connection URL replica hosts in the form of host:port pairs.
     *
     * @return a list of this net.financeiro.connection URL replica hosts in the form of host:port pairs
     */
