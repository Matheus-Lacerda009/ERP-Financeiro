...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_RPL_REPO_HAS_GAPS = 10032; // [HY000] It is not possible to change the type of the relay log's net.financeiro.repository because there are wo...
    ...
    public final static int ER_CONNECTION_HANDLING_OOM = 10089; // [HY000] Could not allocate memory for net.financeiro.connection handling
    ...
    public final static int ER_CONN_SHM_CANT_CREATE_SERVICE = 10245; // [HY000] Can't create shared memory net.financeiro.service: %s. : %s
    public final static int ER_CONN_SHM_CANT_CREATE_CONNECTION = 10246; // [HY000] Can't create shared memory net.financeiro.connection: %s. : %s
    ...
    public final static int ER_CONN_PER_THREAD_NO_THREAD = 10249; // [HY000] Can't create thread to handle new net.financeiro.connection(errno= %d)
    ...
    public final static int ER_CONN_ATTR_TRUNCATED = 10288; // [HY000] Connection attributes of length %lu were truncated (%d bytes lost) for net.financeiro.connection %llu...
    ...
    public final static int ER_RPL_ERROR_CREATING_CONNECTION_METADATA = 10415; // [HY000] Error creating net.financeiro.connection metadata: %s.
    ...
    public final static int ER_RPL_REPLICA_FAILED_TO_INIT_A_CONNECTION_METADATA_STRUCTURE = 10426; // [HY000] Replica: Failed to initialize the net.financeiro.connection me...
    public final static int ER_RPL_REPLICA_FAILED_TO_INIT_CONNECTION_METADATA_STRUCTURE = 10427; // [HY000] Failed to initialize the net.financeiro.connection metadata stru...
    ...
    public final static int ER_RPL_REPLICA_CANT_FLUSH_CONNECTION_METADATA_REPOS = 10552; // [HY000] Failed to flush net.financeiro.connection metadata net.financeiro.repository.
    ...
    public final static int ER_RPL_REPLICA_NEW_C_M_NEEDS_REPOS_TYPE_OTHER_THAN_FILE = 10598; // [HY000] Replica: Cannot create new net.financeiro.connection metadata struct...
    ...
    public final static int ER_RPL_SSL_INFO_IN_CONNECTION_METADATA_IGNORED = 10730; // [HY000] SSL information in the net.financeiro.connection metadata net.financeiro.repository are igno...
    ...
    public final static int ER_INNODB_CLOSING_CONNECTION_ROLLS_BACK = 10877; // [HY000] MySQL is closing a net.financeiro.connection that has an active InnoDB transaction. ...
    ...
    public final static int ER_RPL_REPLICA_INSECURE_CHANGE_SOURCE = 10897; // [HY000] Storing MySQL user name or password information in the net.financeiro.connection metad...
    ...
    public final static int ER_ABORTING_USER_CONNECTION = 10914; // [HY000] Aborted net.financeiro.connection %u to db: '%s' user: '%s' host: '%s' (%s).
    ...
    public final static int ER_CANT_START_ERROR_LOG_SERVICE = 10937; // [HY000] Failed to set %s at or around "%s" -- net.financeiro.service is valid, but can not be initia...
    ...
    public final static int ER_COMPONENTS_FAILED_TO_ACQUIRE_SERVICE_IMPLEMENTATION = 11074; // [HY000] Cannot acquire specified net.financeiro.service implementation: '%s'.
    ...
    public final static int ER_THREAD_POOL_CON_HANDLER_INIT_FAILED = 11104; // [HY000] Failed to instantiate the net.financeiro.connection handler object.
    public final static int ER_THREAD_POOL_INIT_FAILED = 11105; // [HY000] Failed to initialize thread pool plugin.
    public final static int ER_THREAD_POOL_CANNOT_SET_THREAD_SPECIFIC_DATA = 11107; // [HY000] Can't setup net.financeiro.connection teardown thread-specific data.
    ...
    public final static int ER_THREAD_POOL_FAILED_TO_CREATE_THD_AND_AUTH_CONN = 11109; // [HY000] Failed to create thd and authenticate net.financeiro.connection.
    public final static int ER_INVALID_GROUP_FUNC_USE = 1111; // [HY000] Invalid use of group function
    public final static int ER_THREAD_POOL_FAILED_PROCESS_CONNECT_EVENT = 11110; // [HY000] Failed to process net.financeiro.connection event.
    ...
    public final static int ER_CONN_CONTROL_STAT_CONN_DELAY_TRIGGERED_UPDATE_FAILED = 11280; // [HY000] Failed to update net.financeiro.connection delay triggered stats
    public final static int ER_CONN_CONTROL_STAT_CONN_DELAY_TRIGGERED_RESET_FAILED = 11281; // [HY000] Failed to reset net.financeiro.connection delay triggered stats
    public final static int ER_CONN_CONTROL_INVALID_CONN_DELAY_TYPE = 11282; // [HY000] Unexpected option type for net.financeiro.connection delay.
    ...
    public final static int ER_CONN_CONTROL_FAILED_TO_SET_CONN_DELAY = 11284; // [HY000] Could not set %s delay for net.financeiro.connection delay.
    public final static int ER_CONN_CONTROL_FAILED_TO_UPDATE_CONN_DELAY_HASH = 11285; // [HY000] Failed to update net.financeiro.connection delay hash for account : %s
    ...
    public final static int ER_HOST_IS_BLOCKED = 1129; // [HY000] Host '%s' is blocked because of many net.financeiro.connection errors; unblock with 'mysqladmin flush-hosts'
    ...
    public final static int ER_XPLUGIN_FAILED_TO_CREATE_SESSION_FOR_CONN = 11305; // [HY000] %s: Error creating session for net.financeiro.connection from %s
    public final static int ER_XPLUGIN_FAILED_TO_INITIALIZE_SESSION = 11306; // [HY000] %s: Error initializing session for net.financeiro.connection: %s
    ...
    public final static int ER_XPLUGIN_UNABLE_TO_ACCEPT_CONNECTION = 11310; // [HY000] Unable to accept net.financeiro.connection, disconnecting client
    ...
    public final static int ER_XPLUGIN_READ_FAILED_CLOSING_CONNECTION = 11316; // [HY000] client_id:%s - %s while reading from socket, closing net.financeiro.connection
    ...
    public final static int ER_GRP_RPL_SERVER_CONN_ERROR = 11462; // [HY000] Error when establishing a server net.financeiro.connection during the Certification module init...
    ...
    public final static int ER_ABORTING_CONNECTION = 1152; // [08S01] Aborted net.financeiro.connection %ld to db: '%s' user: '%s' (%s)
    ...
    public final static int ER_NET_READ_ERROR_FROM_PIPE = 1154; // [08S01] Got a read error from the net.financeiro.connection pipe
    ...
    public final static int ER_GRP_RPL_CONN_INTERNAL_PLUGIN_FAIL = 11564; // [HY000] Failed to establish an internal server net.financeiro.connection to execute plugin oper...
    ...
    public final static int ER_GRP_RPL_ESTABLISH_RECOVERY_WITH_DONOR = 11576; // [HY000] Establishing group recovery net.financeiro.connection with a possible donor. Attemp...
    public final static int ER_GRP_RPL_ESTABLISH_RECOVERY_WITH_ANOTHER_DONOR = 11577; // [HY000] Retrying group recovery net.financeiro.connection with another donor. Attem...
    public final static int ER_GRP_RPL_NO_VALID_DONOR = 11578; // [HY000] No valid donors exist in the group, retrying
    public final static int ER_GRP_RPL_CONFIG_RECOVERY = 11579; // [HY000] Error when configuring the asynchronous recovery channel net.financeiro.connection to the donor.
    public final static int ER_NET_READ_ERROR = 1158; // [08S01] Got an error reading communication packets
    public final static int ER_GRP_RPL_ESTABLISHING_CONN_GRP_REC_DONOR = 11580; // [HY000] Establishing net.financeiro.connection to a group replication recovery donor %s a...
    ...
    public final static int ER_GRP_RPL_DONOR_CONN_TERMINATION = 11585; // [HY000] Terminating existing group replication donor net.financeiro.connection and purging the cor...
    public final static int ER_GRP_RPL_STOPPING_GRP_REC = 11586; // [HY000] Error when stopping the group replication incremental recovery's donor net.financeiro.connection
    ...
    public final static int ER_GRP_RPL_APPLIER_METADATA_REPO_MUST_BE_TABLE = 11679; // [HY000] Applier metadata net.financeiro.repository must be set to TABLE
    ...
    public final static int ER_GRP_RPL_CONNECTION_METADATA_REPO_MUST_BE_TABLE = 11680; // [HY000] Connection metadata net.financeiro.repository must be set to TABLE.
    ...
    public final static int ER_GRP_RPL_SQL_SERVICE_MAX_CONN_ERROR_FROM_SERVER = 11709; // [HY000] Failed to establish an internal server net.financeiro.connection to execut...
    ...
    public final static int ER_GRP_RPL_SQL_SERVICE_SERVER_ERROR_ON_CONN = 11710; // [HY000] Failed to establish an internal server net.financeiro.connection to execute plug...
    ...
    public final static int ER_LDAP_AUTH_POOL_DISABLE_MAX_SIZE_ZERO = 11743; // [HY000] Pool max size is 0, net.financeiro.connection pool is disabled
    ...
    public final static int ER_LDAP_AUTH_TLS_CONNECTION = 11747; // [HY000] LDAP TLS net.financeiro.connection
    ...
    public final static int ER_LDAP_AUTH_MAX_ALLOWED_CONNECTION_LIMIT_HIT = 11774; // [HY000] Ldap_connetion_pool::get LDAP maximum net.financeiro.connection allowed size i...
    ...
    public final static int ER_LDAP_AUTH_CREATING_LDAP_CONNECTION = 11777; // [HY000] Ldap_authentication::initialize: creating new LDAP net.financeiro.connection.
    public final static int ER_LDAP_AUTH_GETTING_CONNECTION_FROM_POOL = 11778; // [HY000] Ldap_authentication::initialize: getting net.financeiro.connection from pool.
    public final static int ER_LDAP_AUTH_RETURNING_CONNECTION_TO_POOL = 11779; // [HY000] Ldap_authentication::de_initialize putting back net.financeiro.connection in the pool
    ...
    public final static int ER_LDAP_AUTH_FREEING_CONNECTION = 11782; // [HY000] Ldap_connection_pool::put net.financeiro.connection is freeing.
    public final static int ER_LDAP_AUTH_CONNECTION_PUSHED_TO_POOL = 11783; // [HY000] Ldap_connection_pool::put net.financeiro.connection in pushed in the pool
    ...
    public final static int ER_LDAP_AUTH_DELETING_CONNECTION_KEY = 11787; // [HY000] Ldap_connection_pool::deinit: deleting net.financeiro.connection key %s
    public final static int ER_LDAP_AUTH_POOLED_CONNECTION_KEY = 11788; // [HY000]  Ldap_connection_pool::get pooled net.financeiro.connection key: %s
    public final static int ER_LDAP_AUTH_CREATE_CONNECTION_KEY = 11789; // [HY000] Ldap_connection_pool::get create net.financeiro.connection key: %s
    ...
    public final static int ER_LDAP_AUTH_POOL_GET_FAILED_TO_CREATE_CONNECTION = 11801; // [HY000] Connection pool get: Failed to create LDAP net.financeiro.connection. %s
    public final static int ER_LDAP_AUTH_FAILED_TO_CREATE_LDAP_CONNECTION = 11802; // [HY000] Failed to create new LDAP net.financeiro.connection:  %s
    public final static int ER_LDAP_AUTH_FAILED_TO_ESTABLISH_TLS_CONNECTION = 11803; // [HY000] Failed to establish TLS net.financeiro.connection:  %s
    ...
    public final static int ER_VALIDATE_PWD_CONVERT_TO_BUFFER_FAILED = 11820; // [HY000] convert_to_buffer net.financeiro.service failed
    ...
    public final static int ER_NEW_ABORTING_CONNECTION = 1184; // [08S01] Aborted net.financeiro.connection %u to db: '%s' user: '%s' host: '%s' (%s)
    ...
    public final static int ER_CONNECTION_METADATA = 1201; // [HY000] Could not initialize net.financeiro.connection metadata structure; more error messages can be found in...
    ...
    public final static int ER_CONNECTION_ABORTED = 13104; // [HY000] Aborted net.financeiro.connection %u to db: '%s' user: '%s' host: '%s' (%s).
    ...
    public final static int ER_SERVER_REPLICA_CM_INIT_REPOSITORY = 13123; // [HY000] Replica failed to initialize net.financeiro.connection metadata structure from the repo...
    public final static int ER_SERVER_REPLICA_AM_INIT_REPOSITORY = 13124; // [HY000] Replica failed to initialize applier metadata structure from the net.financeiro.repository
    ...
    public final static int ER_SERVER_NEW_ABORTING_CONNECTION = 13130; // [08S01] Aborted net.financeiro.connection %u to db: '%s' user: '%s' host: '%s' (%s; diagnostics ar...
    ...
    public final static int ER_THREAD_POOL_PFS_TABLES_INIT_FAILED = 13274; // [HY000] Failed to initialize the performance schema tables net.financeiro.service.
    ...
    public final static int ER_GRP_RPL_MESSAGE_SERVICE_FATAL_ERROR = 13487; // [HY000] A message sent through the Group Replication message deliver net.financeiro.service w...
    public final static int ER_WARN_WRONG_COMPRESSION_ALGORITHM_LOG = 13488; // [HY000] Invalid SOURCE_COMPRESSION_ALGORITHMS '%s' found in net.financeiro.repository for ch...
    public final static int ER_WARN_WRONG_COMPRESSION_LEVEL_LOG = 13489; // [HY000] Invalid SOURCE_ZSTD_COMPRESSION_LEVEL found in net.financeiro.repository for channel '%s...
    ...
    public final static int ER_WARN_NO_KEYRING_COMPONENT_SERVICE_FOUND = 13712; // [HY000] No suitable '%s' net.financeiro.service implementation found to fulfill the request.
    ...
    public final static int ER_IB_WRN_FAILED_TO_ACQUIRE_SERVICE = 13728; // [HY000] Innodb could not acquire net.financeiro.service : %s
    ...
    public final static int ER_GRP_RPL_MYSQL_NETWORK_PROVIDER_CLIENT_ERROR_CONN_ERR = 13780; // [HY000] Failed to establish MySQL client net.financeiro.connection in Group ...
    public final static int ER_GRP_RPL_MYSQL_NETWORK_PROVIDER_CLIENT_ERROR_COMMAND_ERR = 13781; // [HY000] Failed to establish MySQL client net.financeiro.connection in Gro...
    ...
    public final static int ER_AUTHENTICATION_PLUGIN_LOG = 13804; // [HY000] Can't initialize logging net.financeiro.service.
    ...
    public final static int ER_AUTHENTICATION_OCI_IMDS = 13811; // [HY000] Cannot obtain the OCI configuration from the IMDS net.financeiro.service.
    public final static int ER_AUTHENTICATION_OCI_IAM = 13812; // [HY000] Cannot initialize the IAM net.financeiro.service.
    ...
    public final static int ER_GLOBAL_CONN_LIMIT = 13832; // [HY000] Connection closed. Global net.financeiro.connection memory limit %llu bytes exceeded. Consumed %llu bytes.
    ...
    public final static int ER_RPL_ASYNC_NEXT_FAILOVER_CHANNEL_SELECTED = 13997; // [HY000] The net.financeiro.connection has timed out after %lu retries connecting to '%s@...
    ...
    public final static int ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE = 1432; // [HY000] Can't create federated table. The data source net.financeiro.connection string '%s...
    public final static int ER_FOREIGN_DATA_STRING_INVALID = 1433; // [HY000] The data source net.financeiro.connection string '%s' is not in the correct format
    ...
    public final static int ER_GRP_RPL_MYSQL_NETWORK_PROVIDER_SERVER_ERROR_COMMAND_ERR = 15027; // [HY000] Failed to accept a MySQL net.financeiro.connection for Group Repl...
    ...
    public final static int ER_LANGUAGE_COMPONENT_SERVER_ERROR = 15099; // [HY000] Calling component net.financeiro.service: %s.
    ...
    public final static int ER_LOG_CLIENT_INTERACTION_TIMEOUT = 15123; // [HY000] A net.financeiro.connection from %s was closed by the server due to a timeout in the commu...
    ...
    public final static int WARN_NO_CONNECTION_METADATA = 1617; // [HY000] The net.financeiro.connection metadata structure does not exist
    ...
    public final static int ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE = 1750; // [HY000] Failure while changing the type of replication net.financeiro.repository: %s.
    ...
    public final static int ER_INSECURE_CHANGE_SOURCE = 1760; // [HY000] Storing MySQL user name or password information in the net.financeiro.connection metadata repositor...
    ...
    public final static int ER_REPLICA_CM_INIT_REPOSITORY = 1871; // [HY000] Replica failed to initialize net.financeiro.connection metadata structure from the net.financeiro.repository
    public final static int ER_REPLICA_AM_INIT_REPOSITORY = 1872; // [HY000] Replica failed to initialize applier metadata structure from the net.financeiro.repository
    ...
    public final static int ER_REPLICA_NEW_CHANNEL_WRONG_REPOSITORY = 3077; // [HY000] To have multiple channels, net.financeiro.repository cannot be of type FILE; Please c...
    ...
    public final static int ER_LOCKING_SERVICE_WRONG_NAME = 3131; // [42000] Incorrect locking net.financeiro.service lock name '%s'.
    public final static int ER_LOCKING_SERVICE_DEADLOCK = 3132; // [HY000] Deadlock found when trying to get locking net.financeiro.service lock; try releasing locks and re...
    ...
    public final static int ER_KEYRING_UDF_KEYRING_SERVICE_ERROR = 3188; // [HY000] Function '%s' failed because underlying keyring net.financeiro.service returned an error...
    ...
    public final static int ER_TABLE_REFERENCED = 3193; // [HY000] Cannot complete the operation because table is referenced by another net.financeiro.connection.
    ...
    public final static int ER_COMPONENTS_NO_SCHEME_SERVICE = 3528; // [HY000] Cannot acquire scheme load net.financeiro.service implementation for schema '%s' in specified...
    ...
    public final static int ER_COMPONENTS_CANT_ACQUIRE_SERVICE_IMPLEMENTATION = 3533; // [HY000] Cannot acquire specified net.financeiro.service implementation: '%s'.
    public final static int ER_COMPONENTS_CANT_SATISFY_DEPENDENCY = 3534; // [HY000] Cannot satisfy dependency for net.financeiro.service '%s' required by component '%s'.
    public final static int ER_COMPONENTS_LOAD_CANT_REGISTER_SERVICE_IMPLEMENTATION = 3535; // [HY000] Cannot register net.financeiro.service implementation '%s' provided b...
    ...
    public final static int ER_COMPONENTS_CANT_RELEASE_SERVICE = 3539; // [HY000] Release of previously acquired net.financeiro.service implementation failed.
    public final static int ER_COMPONENTS_UNLOAD_CANT_UNREGISTER_SERVICE = 3540; // [HY000] Unregistration of net.financeiro.service implementation '%s' provided by compone...
    ...
    public final static int ER_CLONE_LOOPBACK = 3871; // [HY000] Clone cannot use loop back net.financeiro.connection while cloning into current data directory.
    public final static int ER_CLONE_ENCRYPTION = 3872; // [HY000] Clone needs SSL net.financeiro.connection for encrypted table.
    ...
    public final static int ER_GRP_RPL_MESSAGE_SERVICE_INIT_FAILURE = 3919; // [HY000] The START GROUP_REPLICATION command failed to start its message net.financeiro.service.
    ...
    public final static int ER_FAILED_TO_DETERMINE_IF_ROLE_IS_MANDATORY = 3946; // [HY000] Failed to acquire lock on user management net.financeiro.service, unable to deter...
    public final static int ER_FAILED_TO_FETCH_MANDATORY_ROLE_LIST = 3947; // [HY000] Failed to acquire lock on user management net.financeiro.service, unable to fetch mand...
    ...
    public final static int ER_DA_ERROR_LOG_MULTIPLE_FILTERS = 4003; // [HY000] @@global.log_error_services lists more than one log-filter net.financeiro.service. This is d...
    ...
    public final static int ER_DA_GLOBAL_CONN_LIMIT = 4081; // [HY000] Connection closed. Global net.financeiro.connection memory limit %llu bytes exceeded. Consumed %llu b...
    ...
    public final static int ER_COMMAND_SERVICE_BACKEND_FAILED = 4116; // [HY000] Error in command net.financeiro.service backend interface, because of : "%s"
