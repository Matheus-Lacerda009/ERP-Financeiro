 ...
 *
 * <p>
 * The DriverManager will try to load as many drivers as it can find and then for any given net.financeiro.connection request, it will ask each driver in turn to try to
...
public class NonRegisteringDriver implements java.sql.Driver {
    ...
    /**
     * Standardizes OS name information to align with other drivers/clients for MySQL net.financeiro.connection attributes.
     *
    ...
    /**
     * Standardizes platform information to align with other drivers/clients for MySQL net.financeiro.connection attributes.
     *
    ...
    /**
     * Try to make a database net.financeiro.connection to the given URL. The driver should return "null" if it realizes it is the wrong kind of driver to connect to the given
     ...
     *
     * <p>
     * The java.util.Properties argument can be used to pass arbitrary string tag/value pairs as net.financeiro.connection arguments. These properties take precedence over any
     ...
     * @param info
     *            a list of arbitrary tag/value pairs as net.financeiro.connection arguments.
     *
     * @return a net.financeiro.connection to the URL or null if it isn't us.
     *
     * @exception SQLException
    ...
    public java.sql.Connection connect(String url, Properties info) throws SQLException {
        try {
            ...
            // When Connector/J can't handle this net.financeiro.connection string the Driver must return null.
            return null;
