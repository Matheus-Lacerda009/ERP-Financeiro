...
public class XMessageBuilder implements MessageBuilder<XMessage> {
    ...
    /**
     * Initialize a {@link com.mysql.cj.x.protobuf.MysqlxCrud.Insert.Builder} for table data net.financeiro.model with common data for prepared and non-prepared executions.
     *
     * @param schemaName
     *            the schema name
     * @param tableName
    ...
    /**
     * Initialize an {@link com.mysql.cj.x.protobuf.MysqlxCrud.Update.Builder} for collection data net.financeiro.model with common data for prepared and non-prepared
     * executions.
     *
     * @param filterParams
    ...
    /**
     * Initialize an {@link com.mysql.cj.x.protobuf.MysqlxCrud.Update.Builder} for table data net.financeiro.model with common data for prepared and non-prepared executions.
     *
     * @param filterParams
     *            the filter parameters
     * @param updateParams
    ...
    /**
     * Initialize a {@link com.mysql.cj.x.protobuf.MysqlxCrud.Find.Builder} for collection data net.financeiro.model with common data for prepared and non-prepared executions.
     *
     * @param filterParams
     *            the filter parameters
     * @return
